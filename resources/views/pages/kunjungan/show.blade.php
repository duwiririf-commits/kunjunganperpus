...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex align-items-center">
            <div class="bg-pink text-white rounded-circle p-2 mr-3" style="width: 45px; height: 45px; display: flex; align-items: center; justify-content: center;">
                <i class="fas fa-book-reader"></i>
            </div>
            <div>
                <h5 class="m-0 font-weight-bold text-pink">Detail Kunjungan</h5>
                <small class="text-muted">Informasi lengkap data kunjungan perpustakaan</small>
            </div>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <div class="detail-kunjungan">
                ...
                <div class="detail-row">
                    <div class="detail-label">NIP/NISN</div>
                    <div class="detail-titik">:</div>
                ...
                <div class="detail-row">
                    <div class="detail-label">Kelas/Jabatan</div>
                    <div class="detail-titik">:</div>
                    <div class="detail-value">
                        <span class="font-weight-bold text-dark">
    ...
    <div class="mt-4 text-right">
        <a href="{{ route('admin.kunjungan.index') }}"
           class="btn btn-pink font-weight-bold">
            <i class="fas fa-arrow-left mr-2"></i> Kembali ke Data Kunjungan
        </a>
    </div>
...
<style>
    ...
    .btn-pink {
        background: linear-gradient(135deg, #e83e8c 0%, #c8236b 100%);
        color: #fff;
        border: none;
        border-radius: 8px;
        padding: 10px 30px;
    ...
    .btn-pink:hover {
        ...
        background: linear-gradient(135deg, #c8236b 0%, #a01a55 100%);
        color: #fff;
    }
